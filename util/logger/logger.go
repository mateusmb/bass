...
// Hook returns a logger with h Hook.
...
// Panic starts a new message with panic level. The message is also
// sent to the panic function.
...
// Log starts a new message with no level. Setting zerolog.GlobalLevel
// to zerolog.Disabled will still disable events produced by this method.
